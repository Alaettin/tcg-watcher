...
import { Activity, Bookmark, ListChecks, Store, Tag, TrendingUp, Bell, Settings as SettingsIcon } from "lucide-react";
...
const ITEMS = [
  ...
  { to: "/prospekte", label: "Prosp.", icon: Tag },
  { to: "/cardmarket", label: "CM", icon: TrendingUp },
